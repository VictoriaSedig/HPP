...
.L87:
	...
	vaddsd	(%r8,%rax), %xmm0, %xmm0
	vmulsd	%xmm1, %xmm0, %xmm0
	vmovsd	%xmm0, 8(%r10,%rdx)
	movq	(%rsi), %r10
	movq	8(%rsi), %r8
	vmovsd	(%r10,%r9), %xmm0
	vaddsd	(%r10,%rax), %xmm0, %xmm0
	vaddsd	(%r8,%r9), %xmm0, %xmm0
	vaddsd	(%r8,%rax), %xmm0, %xmm0
	vmulsd	%xmm2, %xmm0, %xmm0
	movq	(%r11), %r10
	vmovsd	%xmm0, 8(%rdx,%r10)
	addq	$16, %rdx
	cmpq	%rax, %rbp
	jne	.L87
	jmp	.L92
